...
| Projekt-/Domänen-Wissen abrufen oder zurückschreiben (Wissensdoktrin, separat von CDP5) | `nsai-edge`-Wissensbasis — eigener `<!-- nsai -->`-Block via `nsai-init` (Tier-1-MCP, `graph__*`-Tools, Two-Door) |
